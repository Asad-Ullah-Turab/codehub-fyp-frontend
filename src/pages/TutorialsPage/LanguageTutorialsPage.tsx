    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">Loading {language} tutorials...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <span className="text-3xl">{getLanguageEmoji(language || '')}</span>
                <div>
      ...
      <div className="flex h-[calc(100vh-4rem)]">
        {/* Sidebar */}
        <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-80 bg-white shadow-lg transform transition-transform duration-300 ease-in-out`}>
          ...
          {selectedTutorial ? (
                    ...
                    <div className="mt-12">
                      ...
                      <div className="space-y-4">
                        {selectedTutorial.notes.map((note, index) => (
                          <div key={index} className="flex space-x-3 p-4 bg-blue-50 rounded-xl border-l-4 border-blue-400">
                    ...
                    <div className="mt-12">
                      ...
                      <div className="space-y-4">
                        {selectedTutorial.tips.map((tip, index) => (
                          <div key={index} className="flex space-x-3 p-4 bg-yellow-50 rounded-xl border-l-4 border-yellow-400">
                  ...
                  {selectedTutorial.codeExamples && selectedTutorial.codeExamples.length > 0 && (
                    <div className="mt-12">
                      ...
                      <div className="space-y-8">
                        {selectedTutorial.codeExamples.map((example, index) => (
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">Select a Tutorial</h2>
                <p className="text-gray-600">Choose a tutorial from the sidebar to get started</p>
              </div>
            </div>
          )}
        </div>
