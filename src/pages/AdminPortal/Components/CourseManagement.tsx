...
export default function CourseManagement({ highlightedCourseId }: CourseManagementProps) {
  ...
  const openEditModal = (course: Course) => {
    setFormData({
      ...
      certificateSignerName: course.certificateSignerName || "",
      certificateSignerTitle: course.certificateSignerTitle || "",
      certificateSealLabel: course.certificateSealLabel || "",
      certificateFooterText: course.certificateFooterText || "",
      tags: course.tags || [],
    ...
    <AdminPageLayout
      ...
      actions={
        <button
          ...
          className="theme-primary-button inline-flex items-center rounded-full px-4 py-2 text-sm font-medium text-white"
        >
