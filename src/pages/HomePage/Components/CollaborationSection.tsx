      ...
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="text-gray-900">
          ...
          <p className="text-lg text-gray-700 lg:mb-8 mb-4">
            Work smarter, not harder—with CodeHub’s AI-powered collaboration
            tools. Code together in real time, chat with our intelligent AI
            assistant, and let Copilot guide you through complex problems. Share
            projects, review code, and build faster as a team.
          </p>
          ...
          <p className="text-xl font-medium text-gray-800 mb-4">
            CodeHub makes learning and building effortless. The AI Copilot feels
            like a teammate who’s always ready to help.
          </p>
          <p className="text-gray-600 text-sm">
            Sarah, Computer Science Student // CodeHub User
          </p>
        </div>
