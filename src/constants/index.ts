...
export const API_ENDPOINTS = {
  ...
  PROFILE_CREATOR_APPLICATION: "/profile/creator-application",
  ...
  ADMIN_CREATOR_APPLICATIONS_PENDING: "/admin/creator-applications/pending",
  ADMIN_CREATOR_COURSE_PUBLISH_REQUESTS: "/admin/creator-courses",
  ADMIN_CREATOR_COURSE_PUBLISH_REQUESTS_PENDING: "/admin/creator-courses/pending",
  ...
  CREATOR_COURSES_MY: "/creator/courses/my-courses",
