    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      <section className="bg-gray-900 text-white text-center py-20 px-4">
        ...
        <p className="text-gray-300 max-w-3xl mx-auto">
          CodeHub was created to make high-quality coding education accessible
          to everyone, everywhere. We're here to help you solve today’s problems
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            <img
              ...
              className="w-24 h-24 rounded-full mx-auto mb-4"
            />
            <h3 className="text-lg font-bold">Samuel Lee</h3>
      ...
      <section className="py-16 px-6 text-center bg-gray-900 text-white">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto mb-8">
          Be part of the CodeHub journey. Whether you’re looking to share your
